  ...
  return (
    <>
      ...
      <section className="hero bg-[#0c0c0c]">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 lg:gap-0 h-[600px] md:h-[450px] lg:h-auto items-center px-5 lg:p-0">
          <div className="lg:pl-40">
            <h1 className="text-white text-[22px] lg:text-4xl font-bold lg:pr-10 lg:leading-[45px]">Save Big on Optimum Plans Bundle Fiber Internet + Mobile Starting from $45/Month</h1>
      ...
      <section className="mx-auto max-w-screen-xl py-10 px-14 lg:px-5 bg-white">
        <h2 className="text-center font-bold text-2xl">Start Your Savings with Optimum Today!</h2>
        <p className="text-center pt-3">Get 99.9% network reliability and greater whole home WiFi coverage.</p>
        <div className="grid grid-cols-1 gap-5 md:grid-cols-3 lg:grid-cols-3 lg:gap-60 mt-10 items-center">
          <div className="rounded-full bg-primary text-center py-14">
            <Image src="/5G.webp" alt="" width={50} height={50} className="mx-auto" />
      ...
      <section className="bg-[#f2f2f2] py-10 px-5">
        <div className="grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-2 lg:gap-8 mx-auto max-w-screen-xl items-center">
          <div className="items-center">
            <h2 className="text-3xl font-bold lg:pr-72">Get <span className="text-primary">WiFi 6E FREE</span> with 1 Gig Internet</h2>
            <ul className="mt-3">
              <li className="flex gap-2"><Plus className="text-primary w-4" /> <span className="font-bold">Powers 100+ devices</span> with greater performance and less lag</li>
              <li className="flex gap-2"><Plus className="text-primary w-4" /> <span className="font-bold">Reliable connection</span> in busy households</li>
              <li className="flex gap-2"><Plus className="text-primary w-4" /> <span className="font-bold">Conserves battery life</span> by reducing unnecessary activity</li>
            </ul>
          </div>
          <div className="items-center">
            <Image src="/wifi.webp" alt="" width={300} height={100} className="mx-auto" />
          </div>
        </div>
      </section>
      ...
      <section>
        <div className="mx-auto max-w-screen-xl px-4 py-8 sm:px-6 sm:py-12 lg:px-0 lg:py-16 bg-white">
          <h2 className="text-center font-bold text-2xl">Optimum Fiber Internet has next-level speed.</h2>
          <p className="text-center pt-3">Get 99.9% network reliability and greater whole home WiFi coverage.</p>
          <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 sm:items-stretch md:grid-cols-2 md:gap-8 lg:px-32 my-10">
            <div className="divide-y divide-gray-200 rounded-1xl shadow-2xl">
              <div className="p-6 sm:px-8">
                ...
                <p className="mt-2 sm:mt-4">
                  <sup className="text-primary text-3xl font-bold">$</sup>
                  <strong className="text-3xl font-bold text-primary sm:text-6xl"> 80 </strong>
                  <sup className="text-1xl font-semibold text-gray-700">/mo</sup>
                </p>
          ...
          <div className="grid grid-cols-1 gap-4 sm:items-stretch md:grid-cols-2 lg:grid-cols-3 md:gap-8 px-5">
            <div className="divide-y divide-gray-200 rounded-1xl shadow-2xl">
              <div className="p-6 sm:px-8">
                <h2 className="text-2xl font-bold text-gray-900">
                  1 Gig
      ...
      <section className="bg-white py-10 px-5">
        <div className="text-center lg:px-20">
          <h2 className="text-center font-bold text-2xl">Ready to get Started?</h2>
          <p className="text-center pt-3">Call us today and snag a custom bundle with crazy fast speeds up to 8 Gig*, and a TV package and total home experience like only Optimum can bring you.</p>
          <p className="text-center pt-3 mb-10 font-bold">*Not available in all areas.</p>
      ...
      <section className="bg-[#f2f2f2] py-10 px-5">
        <div className="mx-auto max-w-screen-xl">
          ...
          <h3 className="font-bold text-2xl pt-5 pb-2">Optimum: Seamless Connectivity and Superior Entertainment</h3>
          <p>Optimum, another subsidiary of Altice USA, is renowned for its comprehensive suite of services designed to deliver seamless connectivity and superior entertainment options. Optimum provides high-speed internet with speeds tailored to meet the demands of modern households and businesses. Additionally, Optimum offers a wide range of cable TV packages featuring diverse channels, premium content, and advanced DVR capabilities. With a focus on customer experience and technological innovation, Optimum ensures that customers have access to reliable communication and entertainment solutions that enhance their daily lives.</p>
          <p>Together, Altice USA, Suddenlink, and Optimum represent a commitment to innovation, customer satisfaction, and community connectivity in the telecommunications industry. Whether you’re looking for robust internet connectivity, extensive entertainment options, or reliable phone services, these brands are dedicated to meeting your needs with cutting-edge technology and exceptional service.</p>

          <h3 className="font-bold text-2xl pt-5 pb-2">Optimum Internet: Fast, Reliable Connectivity</h3>
          <p>Discover the unparalleled speed and reliability of Optimum Internet, designed to meet the needs of both residential and business users alike. Optimum Internet provides robust solutions that ensure seamless connectivity for streaming, gaming, working from home, and more. With Optimum’s advanced infrastructure and technology, you can enjoy consistently high-speed internet access throughout your home or office, supported by Optimum WiFi for reliable coverage in every room.</p>

          <h3 className="font-bold text-2xl pt-5 pb-2">Internet Plans, Options, and Pricing</h3>
          <p>Optimum offers a diverse range of Internet plans tailored to suit various usage patterns and preferences. Whether you’re a light internet user who needs basic browsing capabilities or a heavy user requiring maximum speeds for simultaneous streaming and gaming, Optimum has a plan to fit your needs. Optimum’s plans include options for high-speed superfast internet fulfilling bandwidth requirements with precision for all your online activities. Pricing is competitive and transparent, with no surprise fees, and customers can save more by bundling internet with Optimum’s cable TV and phone services.</p>

          <h3 className="font-bold text-2xl pt-5 pb-2">Optimum WiFi: Seamless Coverage and Security</h3>
          <p>Optimum WiFi enhances your connectivity experience by providing seamless coverage throughout your home. Powered by advanced technology, Optimum WiFi ensures that you stay connected from the basement to the attic, with strong signals that minimize dead zones and maximize speed. Enjoy the convenience of secure WiFi connections for all your devices, including smartphones, tablets, laptops, and smart home gadgets. Optimum WiFi also offers additional security features to protect your network from unauthorized access and cyber threats, giving you peace of mind while browsing, streaming, or shopping online.</p>

          <h3 className="font-bold text-2xl pt-5 pb-2">Why Customers Should Choose Optimum Internet</h3>
          <p>Optimum Internet stands out as the preferred choice for those seeking reliable, high-speed internet access with excellent customer support. By choosing Optimum, customers benefit from:</p>
          <br />
          <p>Speed and Reliability: Experience blazing fast speeds and consistent performance, ideal for streaming HD content and gaming online without interruptions.</p>
          <br />
          <p>Flexibility: Choose from a variety of plans tailored to your specific needs and budget, with options to bundle internet, TV, and phone services for added convenience.</p>
          <br />
          <p>Exceptional Customer Service: Access 24/7 customer support from knowledgeable representatives who are ready to assist with any questions or issues.</p>
          <br />
          <p>Secure Connectivity: Enjoy peace of mind with Optimum WiFi’s robust security features that protect your network and devices from cyber threats.</p>
          <br />
          <p>Optimum Internet is more than just a service; it’s a commitment to providing reliable connectivity that enhances your digital lifestyle. Whether you’re upgrading your home network or setting up a business connection, Optimum Internet delivers the speed, reliability, and support you need to stay connected effortlessly.</p>

          <h3 className="font-bold text-2xl pt-5 pb-2">Optimum Cable: Comprehensive Entertainment Solutions</h3>
          <p>Explore the world of Optimum Cable, offering a diverse range of entertainment options designed to elevate your viewing experience. Optimum Cable provides extensive channel lineups, premium content, and advanced features that cater to the preferences of every viewer. Whether you’re a sports enthusiast, movie buff, or reality TV fan, Optimum TV ensures there’s always something to watch with crystal-clear picture quality and immersive sound.</p>

          <h3 className="font-bold text-2xl pt-5 pb-2">TV Plans, Options, and Pricing</h3>
          <p>Optimum offers flexible TV plans that cater to a variety of viewing preferences and budgets. Choose from a selection of packages that include local channels, sports networks, news channels, and more. Optimum TV plans also feature options for premium channels like HBO, Showtime, and Cinemax, providing access to exclusive movies, original series, and special events. Pricing is transparent, with competitive rates and the ability to bundle TV services with internet and phone for added savings.</p>

          <h3 className="font-bold text-2xl pt-5 pb-2">Why Customers Should Choose Optimum Cable</h3>
          <p>Optimum Cable stands out as the preferred choice for those seeking comprehensive entertainment solutions with exceptional value and quality. By choosing Optimum, customers benefit from:</p>
          <br />
          <p>Extensive Channel Selection: Access a wide range of channels with options to add premium content and international programming to suit diverse tastes.</p>
          <br />
          <p>HD and 4K Programming: Enjoy stunning high-definition and 4K programming for a cinematic viewing experience in the comfort of your home.</p>
          <br />
          <p>Advanced DVR Features: Record your favorite shows, pause live TV, and manage your viewing schedule with Optimum’s advanced DVR capabilities.</p>
          <br />
          <p>User-friendly Interface: Navigate through channels, On-Demand content, and streaming apps effortlessly with Optimum’s intuitive TV interface.</p>
          <br />

        ...
        <>
            ...
            <section className='bg-white py-10 px-5 lg:px-32'>
                <div className=''>
                    ...
                    <br />
                    <p className="text-black">Non-Personal Information</p>
                    <br />

                    <p className="text-black">We may also collect non-personal information to improve our services and enhance your experience. This includes:</p>
                    <br />

                    <p className="text-black">Browser Type: To ensure compatibility and optimize our website performance.</p>
                    <p className="text-black">IP Address: To enhance security and prevent fraud.</p>
                    <p className="text-black">Device Information: To tailor our services to different devices.</p>
                    <p className="text-black">Website Usage Data: To analyze how our website is used and identify areas for improvement.</p>

                    <br />
                    <p className="text-black">How We Use Your Information</p>
                    <p className="text-black">Providing Services</p>

                    <br />
                    <p className="text-black">We use your personal information to:</p>
                    <br />

                    <p className="text-black">Assist you in signing up for Optimum services.</p>
                    <p className="text-black">Process payments and manage your account.</p>
                    <p className="text-black">Communicate with you about your services, inquiries, and support requests.</p>
                    <p className="text-black">Schedule installations and service calls.</p>

                    <br />
                    <p className="text-black">Improving Our Services</p>
                    <br />

                    <p className="text-black">We use non-personal information to:</p>
                    <br />

                    <p className="text-black">Analyze website usage and performance.</p>
                    <p className="text-black">Improve our website and services.</p>
                    <p className="text-black">Enhance user experience.</p>
                    <p className="text-black">Develop new features and offerings.</p>

                    <br />
                    <p className="text-black">Marketing and Promotions</p>
                    <br />

                    <p className="text-black">With your consent, we may use your personal information to:</p>
                    <br />

                    <p className="text-black">Send you promotional offers and updates about Optimum services.</p>
                    <p className="text-black">Inform you about new products, services, and special offers.</p>
                    <p className="text-black">Conduct surveys to improve our services and customer satisfaction.</p>

                    <br />

                    <p className="text-black">Information Sharing and Disclosure</p>
                    <p className="text-black">Authorized Partners</p>

                    <br />

                    <p className="text-black">As an authorized agent for Optimum, we may share your information with Optimum for the purposes of providing the services you requested. Optimum will handle your information in accordance with their own privacy policies.</p>
                    <p className="text-black">Service Providers</p>

                    <br />

                    <p className="text-black">We may share your information with third-party service providers who assist us in delivering our services. These providers are required to protect your information and use it only for the purposes we specify. Examples include:</p>

                    <br />

                    <p className="text-black">Payment processors to handle transactions.</p>
                    <p className="text-black">Customer service platforms to manage inquiries.</p>
                    <p className="text-black">Marketing platforms to distribute promotional materials.</p>

                    <br />
                    <p className="text-black">Legal Compliance</p>
                    <br />

                    <p className="text-black">We may disclose your information if required by law or in response to valid requests by public authorities (e.g., a court or government agency). This includes:</p>
                    ...
                    <br />
                    <p className="text-black">Data Security</p>
                    <br />

                    <p className="text-black">We take the security of your personal information seriously and implement appropriate technical and organizational measures to protect it against unauthorized access, alteration, disclosure, or destruction. These measures include:</p>

                    <br />

                    <p className="text-black">Encryption of sensitive information during transmission.</p>
                    <p className="text-black">Secure storage of data in protected environments.</p>
                    <p className="text-black">Regular security audits and updates.</p>

                    <br />

                    <p className="text-black">While we strive to protect your information, no method of transmission over the Internet or electronic storage is 100% secure, and we cannot guarantee absolute security.</p>
                    <p className="text-black">Your Rights</p>
                    <p className="text-black">Access and Correction</p>

                    <br />

                    <p className="text-black">You have the right to access and correct your personal information. If you need to update or correct your information, please contact us using the details provided below.</p>
                    <p className="text-black">Opt-Out</p>

                    <br />

                    <p className="text-black">You have the right to opt out of receiving marketing communications from us. To opt out, follow the unsubscribe instructions in our emails or contact us directly.</p>
                    <p className="text-black">Data Deletion</p>

                    <br />

                    <p className="text-black">You have the right to request the deletion of your personal information. To request deletion, please contact us using the details provided below.</p>
                    <p className="text-black">Data Portability</p>

                    <br />

                    <p className="text-black">You have the right to request a copy of your personal information in a structured, commonly used, and machine-readable format.</p>
                    <p className="text-black">Restriction of Processing</p>

                    <br />

                    <p className="text-black">You have the right to request the restriction of processing your personal information under certain circumstances, such as if you contest the accuracy of the data or object to our processing.</p>
                    <p className="text-black">Object to Processing</p>

                    <br />

                    <p className="text-black">You have the right to object to the processing of your personal information based on legitimate interests or direct marketing.</p>
                    <p className="text-black">Changes to This Privacy Policy</p>

                    <br />

                    <p className="text-black">We may update this Privacy Policy from time to time to reflect changes in our practices or legal requirements. We will notify you of any significant changes by posting the new Privacy Policy on our website. Your continued use of our services after any changes indicates your acceptance of the updated Privacy Policy.</p>
                    <p className="text-black">Contact Us</p>

                    <br />

                    <p className="text-black">If you have any questions or concerns about this Privacy Policy or how we handle your personal information, please contact us:</p>
                    ...
                    <p className="text-black">Effective Date: 10-05-2024</p>
                </div>
            </section>

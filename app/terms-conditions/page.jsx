        ...
        <>
            ...
            <section className='bg-white py-10 px-5'>
                <div className='mx-auto max-w-screen-xl'>
                    ...
                    <p className="text-black">You must be at least 18 years old to use our services. By using our services, you represent and warrant that you meet this age requirement.</p>
                    <p className="text-black">Account Registration</p>
                    ...
                    <p className="text-black">Service Activation</p>

                    <br />
                    <p className="text-black">Activation of Optimum services is subject to availability and acceptance by Optimum. We facilitate the signup process and provide support, but the final approval and provision of services are managed by Optimum.</p>
                    <p className="text-black">3. Payment and Billing</p>
                    <p className="text-black">Payment Terms</p>
                    <br />

                    <p className="text-black">You agree to pay all charges associated with the services you select. Payment terms, including fees, billing cycles, and payment methods, are determined by Optimum. We may assist in processing payments, but all transactions are subject to Optimum’s terms and conditions.</p>
                    <p className="text-black">Late Payments</p>
                    <br />

                    <p className="text-black">Failure to pay timely may result in service interruptions or termination. Late payments may incur additional fees as outlined in Optimum’s policies.</p>
                    <p className="text-black">Refunds and Cancellations</p>

                    <br />

                    <p className="text-black">Refunds and cancellations are governed by Optimum’s policies. Please refer to Optimum’s terms for detailed information on how to cancel services and request refunds.</p>
                    <p className="text-black">4. Use of Optimum Services</p>
                    <p className="text-black">Acceptable Use</p>

                    <br />
                    <p className="text-black">You agree to use Optimum services for lawful purposes only. You must not use the services to:</p>

                    <br />
                    <p className="text-black">Engage in any illegal activities.</p>
                    <p className="text-black">Violate the rights of others.</p>
                    <p className="text-black">Distribute malicious software or spam.</p>
                    <p className="text-black">Interfere with the operation of Optimum’s network.</p>
                    <br />

                    <p className="text-black">Service Limitations</p>

                    <br />

                    <p className="text-black">Optimum services are subject to availability and may be affected by factors outside our control, such as technical issues or network maintenance. We do not guarantee uninterrupted or error-free service.</p>
                    <p className="text-black">5. Privacy</p>

                    <br />
                    <p className="text-black">Your privacy is important to us. Our Privacy Policy explains how we collect, use, and protect your personal information. By using our services, you consent to our collection and use of your information as described in the Privacy Policy.</p>
                    <p className="text-black">6. Intellectual Property</p>
                    ...
                    <p className="text-black">You are granted a limited, non-exclusive, non-transferable license to access and use our services for personal, non-commercial purposes. You may not reproduce, distribute, or create derivative works from any content without our express written permission.</p>
                    <p className="text-black">7. Disclaimers and Limitation of Liability</p>
                    <p className="text-black">Disclaimer of Warranties</p>

                    <br />
                    <p className="text-black">Our services are provided “as is” and “as available” without warranties of any kind, either express or implied. We disclaim all warranties, including but not limited to, implied warranties of merchantability, fitness for a particular purpose, and non-infringement.</p>
                    ...
                    <p className="text-black">Any unauthorized access to or use of our servers and/or any personal information stored therein.</p>
                    <p className="text-black">Any interruption or cessation of transmission to or from our services.</p>

                    <br />

                    <p className="text-black">8. Indemnification</p>
                    ...
                    <p className="text-black">We reserve the right to terminate or suspend your access to our services, without prior notice or liability, for any reason, including if you breach these Terms and Conditions. Upon termination, your right to use the services will immediately cease.</p>
                    <p className="text-black">10. Governing Law</p>
                    ...
                    <p className="text-black">We may update these Terms and Conditions from time to time. We will notify you of any significant changes by posting the new Terms and Conditions on our website. Your continued use of our services after any changes indicates your acceptance of the updated Terms and Conditions.</p>
                    <p className="text-black">13. Contact Us</p>

                    <br />

                    <p className="text-black">If you have any questions or concerns about these Terms and Conditions, please contact us:</p>

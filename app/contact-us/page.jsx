    ...
    return (
        <>
            ...
            <section className='py-10'>
                <h2 className='text-center font-bold text-2xl'>Contact US Anytime You Want!</h2>
                <p className='text-center pt-2 pb-10'>Have any questions? We’re here to assist you in selecting the best TV, internet, or phone deals round the clock.</p>
                <div className="grid grid-cols-1 gap-4 lg:grid-cols-3 lg:gap-8 mx-auto max-w-screen-xl">
                    <div className="lg:col-span-2">
                        <form action="" method="post">
                            ...
                            <div className='pt-5'>*By clicking on the SUBMIT button, you authorize us to contact you via email or phone number to discuss the available options in your area!</div>
                        </form>
                    </div>
                    <div className="">
                        <div className='text-center px-28 pb-5 mt-5'>
                            <Globe className='mx-auto text-primary w-8 h-8' />
                            <h3 className='font-bold text-2xl py-2'>Find us here</h3>
                            <p>25121 Jericho Turnpike, Jamaica, NY 11426</p>
                        </div>
                        <hr />
                        <div className='text-center p-5'>
                            <Mail className='mx-auto text-primary w-8 h-8' />
                            <h3 className='font-bold text-2xl py-2'>Email Us</h3>
                            <p className='text-primary'>info@optimuminternetretailers.com</p>
                        </div>
                        <hr />
                        <div className='text-center p-5'>
                            <Smartphone className='mx-auto text-primary w-8 h-8' />
                            <h3 className='font-bold text-2xl py-2'>Call Us</h3>
                            <p className='text-primary'>+1-866-830-0112</p>
                            <p>Open Monday to Friday 8:00 AM to 10:00 PM EST</p>
                        </div>
                    </div>
                </div>
            </section>
